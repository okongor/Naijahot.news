# NaijaHot.News - Your Daily Dose of Nigerian News

This is the official repository for NaijaHor.News, a Nigerian news website dedicated to delivering the latest breaking news, in-depth analysis, and insightful commentary on a wide range of topics relevant to Nigerians.

**Features**
Up-to-date News: Stay informed with the latest breaking news across various categories like politics, business, sports, entertainment, and more.
Local Focus: Get in-depth coverage of issues affecting Nigeria and its people.
Diverse Content: Explore a variety of content formats including articles, videos, and interactive features.
Engaging Commentary: Read insightful opinions and analysis from seasoned journalists and experts.
Mobile-friendly: Access the latest news on the go from your mobile device.
Contributing
We welcome contributions from passionate individuals who want to share their stories and perspectives on Nigerian events. Currently, contributions are not open. However, this information might change in the future. Stay tuned for updates!

**Technologies**
This website is built using Next.js, React & Sanity CMS
We leverage the power of [mention relevant libraries or frameworks] for a smooth user experience.

**Deployment**
The website is currently deployed on Vercel

**Support**
If you encounter any issues or have questions, please feel free to contact us at indaboski42@gmail.com
